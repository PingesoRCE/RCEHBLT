...
public class ConsentimientoGes implements Serializable {
    ...
    public ConsentimientoGes(Integer idCges, boolean confirmacionges, boolean confirmaciontratamiento, Date consentimientofecha) {
        this.idCges = idCges;
    ...
    public String toString() {
        return "cl.rcehblt.entities.ConsentimientoGes[ idCges=" + idCges + " ]";
    }
